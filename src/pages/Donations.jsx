...
//         </div>
//       </div>
//       <div className="grid grid-cols-1 md:grid-cols-3 p-3 gap-6">
//         <div className="grid space-y-4 border overflow-hidden rounded-3xl relative">
//           <img
...
//             alt=""
//             className="object-cover w-full h-full rounded-t-3xl overflow-hidden "
//           />
//           <div className="absolute top-24 left-2 ">
//             <span className="w-fit p-2 rounded-full bg-yellow-400 text-[#01715d] font-bold italic text-sm">
//               education
//             </span>
//           </div>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-center p-5">
          <h2 className="font-bold text-[#fbd459] italic text-2xl sm:text-3xl md:text-4xl">
            Donations
          </h2>
        </div>
      </div>
      {/* Donation Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-3 gap-6 mt-6 relative">
        <div className="space-y-4 border overflow-hidden rounded-3xl  p-3">
          <img
            src="https://media.istockphoto.com/id/1434116950/vector/cartoon-people-with-hearts-romantic-persons-funny-guys-girls-and-kids-with-love-and-donate.jpg?s=612x612&w=0&k=20&c=V7a1zMCn1nQrStuQhfIO6Al6tO2dC-S11wK5JjYiDQg="
            alt="Donation Image"
          ...
          <p className="text-gray-600">Donation description goes here.</p>
          <div className="bg-[#f9f4e8] p-10 rounded-3xl">
            <input type="range" min={100} max={1000} className="w-full" />
            <div className="flex items-center justify-between">
              <span>Raised</span>
